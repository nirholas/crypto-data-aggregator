      ...
      items: [
        {
          ...
          type: 'link' as const,
          onPress: () => openLink('https://news-crypto.vercel.app/docs'),
        },
        {
          id: 'github',
          icon: 'logo-github',
        ...
        },
        {
          ...
          icon: 'globe',
          title: 'Website',
          subtitle: 'news-crypto.vercel.app',
          type: 'link' as const,
          onPress: () => openLink('https://news-crypto.vercel.app'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          type: 'link' as const,
          onPress: () => openLink('https://news-crypto.vercel.app/privacy'),
        },
        {
          id: 'terms',
          icon: 'document-text',
          ...
          type: 'link' as const,
          onPress: () => openLink('https://news-crypto.vercel.app/terms'),
        },
      ],
    },
  ];
